...
import { LogOut, Menu, X, Calendar, Utensils } from "lucide-react";

export default function ReceptionLayout({ user, children, onLogout }) {
      ...
      `}>
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between px-6 border-b">
            <div>
              <h2 className="font-serif text-xl font-bold text-[#bd902f]">Reception Portal</h2>
              <p className="text-xs text-neutral-500 capitalize">{user.department} Department</p>
            </div>
            <button
              onClick={() => setSidebarOpen(false)}
          ...
          <nav className="flex-1 px-4 py-6 space-y-2">
            ...
            <div className="flex items-center gap-3 px-4 py-3 rounded-lg bg-[#bd902f] text-white">
              <Calendar size={20} />
          ...
          <div className="border-t p-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-xs text-neutral-500 capitalize">{user.role} - {user.department}</p>
              </div>
            </div>
            <button
              onClick={onLogout}
